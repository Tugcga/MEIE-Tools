# this is original script from gemrb repository
...
FILE_EXT_MAPPING = {
    ...
    'pvrz': 0x404,
    'png':    0x3,
    # 'png':  0x40b,  # Near Infinity use this value
    'res':  0x3FE,
    'spl':  0x3EE,
    'sto':  0x3F6,
    'tis':  0x3EB,
...
def build_chitin_key(root_path: str):
    '''Update chitin.key by using resources from override directory

    Input:
        root_path - full path to the folder with chitin.key file
                    this folder should contains override directory and chitin.key file
    '''
